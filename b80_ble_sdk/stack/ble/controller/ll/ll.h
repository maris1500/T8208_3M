...
/**
 * @brief		this function is used to modify bluetooth version.
 * @param[in]	bluetooth_ver - select the needed bluetooth version, need to input the number.
 *  				BLUETOOTH_VER_4_0		6
 *					BLUETOOTH_VER_4_1		7
 *					BLUETOOTH_VER_4_2		8
 *					BLUETOOTH_VER_5_0		9
 *					BLUETOOTH_VER_5_1		10
 *					BLUETOOTH_VER_5_2		11
 *					BLUETOOTH_VER_5_3		12
 *		        	BLUETOOTH_VER_5_4		13
 * @param[in]	bluetooth_subver - select the needed bluetooth subversion, need to input the number.
 ...
 * @return		none
 */
void blc_ll_modify_version (u8 bluetooth_ver, u16 bluetooth_subver);
