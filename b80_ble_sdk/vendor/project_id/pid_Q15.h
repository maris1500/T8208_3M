...
#define DEVICE_NAME_1  "BOW5.0 BT1"
...
#define KEY_PRESS_HOLD_CHECK_TIME3			2800 //unit 1ms
		...
		#define PIN_SIF_MOTION          GPIO_PB5    //39a30_v1.0 j4 S-tx
	...
	#if SENSOR_CS_ENABLE
		#define PIN_SENSOR_CS          GPIO_PB3    //39a30_v1.0 j4 S-tx
	...
	#define PIN_SIF_SDA                GPIO_PB4    //39a30_v1.0  j15
...
#define KEY_K4_IN_ENABLE   1
#define KEY_K5_IN_ENABLE   1

#define KEY_K4_Independence_CTRL_EN  1
#define KEY_K5_Independence_CTRL_EN  1

#if KEY_DPI_IN_ENABLE || KEY_CPI_INDEPENDENT_ENABLE
	#define KEY_DPI_PIN		GPIO_PD1
#endif
...
#define DEBUG_MODE  1
	...
	#define PIN_WHEEL_1             GPIO_PD6   //39a30_v1.0 j15
	...
	#define WHEEL_ADDRES_D2         0x06
	#define WHEEL_ADDRES_D3         0x07
#endif


#if (LED_G24_ENABLE)
	#define PIN_24G_LED     GPIO_PC2
#endif

#if (LED_BT1_ENABLE)
	#define PIN_BLE1_LED    GPIO_PC1
...
#if (LED_BT2_ENABLE)
	#define PIN_BLE2_LED    GPIO_PC0
#endif

#if (LED_BAT_VOLTAGE_ENABLE) || LED_DPI_INDICATE_ENABLE
	#define PIN_BAT_DPI_LED     GPIO_PC2
#endif
...
#define LED_CODE_PWIR_DRIVE_ENABLE  0

#if LED_CODE_PWIR_DRIVE_ENABLE
	// do nothing
#else
	#define LED_CODE_ENABLE  0
#endif

#define LED_CODE_SW_CHECK_ENABLE  0
#define LED_CODE_POWER_ENABLE     0
...
#define LED_CODE_SW_CLOSE_ENABLE  0
...
#define USB_SWITCH_ENABLE   1

#if USB_SWITCH_ENABLE
	#define  USB_SWITCH_PIN     GPIO_PB2
	#define  USB_SWITCH_ON()   !gpio_read(GPIO_PB2)
