...
#define REG_PAN3204LL_DELTA_X_H             0x11
#define REG_PAN3204LL_DELTA_Y_H             0x12
...
_attribute_ram_code_sec_ int OPTSensor_resync(u32 retry);
